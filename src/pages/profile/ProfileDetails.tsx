  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center space-x-4 mb-8">
        ...
        />
        <div>
          <h3 className="text-[16px] font-medium text-grey500">
      ...
      <div className="space-y-8">
        <div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <p className="text-sm text-grey300 font-normal mb-1">
                First Name
              </p>
              <p className="text-grey500 font-medium text-base">
                {userDetails?.first_name}
              </p>
            </div>
            <div>
              <p className="text-sm text-grey300 font-normal mb-1">Last Name</p>
              <p className="text-grey500 font-medium text-base">
                {userDetails?.last_name}
              </p>
            </div>
            <div>
              <p className="text-sm text-grey300 font-normal mb-1">Email</p>
              <p className="text-grey500 font-medium text-base">
            ...
            <div>
              <p className="text-sm text-grey300 font-normal mb-1">Role</p>
              <p className="text-grey500 font-medium text-base">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <p className="text-sm text-grey300 font-normal mb-1">Country</p>
              <p className="text-grey500 font-medium text-base">
                {userDetails?.country}
              </p>
            </div>
